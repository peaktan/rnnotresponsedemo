...
@ReactModule(name = ReactModalHostManagerOld.REACT_CLASS)
public class ReactModalHostManagerOld extends ViewGroupManager<ReactModalHostView>
    implements ModalHostViewManagerInterface<ReactModalHostView> {

  public static final String REACT_CLASS = "RCTModalHostViewOld";

  private final ViewManagerDelegate<ReactModalHostView> mDelegate;

  public ReactModalHostManagerOld() {
